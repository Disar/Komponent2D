...
class Painter
{
	...
	public static var matrix(get, set):FastMatrix;
	...
	private static inline function get_matrix():FastMatrix { return g2.transformation; }
	private static inline function set_matrix(value:FastMatrix):FastMatrix
	{
		if (value == null) g2.popTransformation();
		else g2.pushTransformation(value);
		return value;
	}
}