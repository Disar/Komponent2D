...
class CollisionData2D
{
	...
	private var data:ShapeCollision;
	
	public function new(data:ShapeCollision, coll1:Collider, coll2:Collider, physics:Physics, event:CollisionEvent)
	{
		this.data = data;
		collider1 = coll1;
		collider2 = coll2;
	...
	private inline function get_separation():Point { return new Point(data.separationX,data.separationY); }
	private inline function get_shape1():Shape { return data.shape1; }
	private inline function get_shape2():Shape { return data.shape2; }
	private inline function get_unitVector():Point { return new Point(data.unitVectorX,data.unitVectorY); }
}